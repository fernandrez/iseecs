...
var lbtc_const = require('./lbtc_const');
var LBCClient = require('./lbtc_client');
var lbc = new LBCClient(config.lbtc.id, config.lbtc.secret);

let parseStr = (str, pars) => { return str.replace(/%\w+%/g, function(all) { return pars[all] || all; }) }

let apiCall = (endpoint, params) => {
  return new Promise((resolve, reject) => {
    lbc.api(endpoint, params, function(error, data) {
